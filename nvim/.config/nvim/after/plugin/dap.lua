...
vim.keymap.set('n', '<Leader>dB', function() dap.set_breakpoint(vim.fn.input('Expression: ')) end)
vim.keymap.set("n", "<leader>dE", function() dap.set_exception_breakpoints({ "Warning", "Error", "Exception" }) end, { desc = "Stop on exceptions" })
vim.keymap.set("n", "<leader>dA", function() dap.set_exception_breakpoints({ "Notice", "Warning", "Error", "Exception" }) end, { desc = "Stop on all" })
